...
def init(
    ...
    ai_assistant: str = typer.Option(None, "--ai", help="AI assistant to use: claude, gemini, copilot, cursor-agent, qwen, opencode, codex, windsurf, kilocode, auggie, codebuddy, amp, shai, warp, or q"),
...
def version():
    ...
    cli_version = "unknown"
    try:
        cli_version = importlib.metadata.version("warp-kit")
    except Exception:
